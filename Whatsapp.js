...
client.on('message', message => {
	if(message.body === 'Hi') {
        ...
        client.sendMessage(message.from, MessageMedia.fromFilePath('C:/Users/rithi/Desktop/Random/Whatsapp/ECE.pdf'));
    }
    else if(message.body ==='Cie'){
        client.sendMessage(message.from, MessageMedia.fromFilePath('C:/Users/rithi/Desktop/Random/Whatsapp/Cie.jpg'));
    }
    else if(message.body ==='Food'){
        client.sendMessage(message.from, MessageMedia.fromFilePath('C:/Users/rithi/Desktop/Random/Whatsapp/Menu.pdf'));
    }
    });
